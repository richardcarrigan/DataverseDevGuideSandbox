...
namespace ExampleConsoleApp
{
  ...
  class Program
  {
    static async Task Main()
    {
      ...
      string resource = "https://org8b0dc140.api.crm.dynamics.com";
      ...
      IPublicClientApplication authBuilder = PublicClientApplicationBuilder
        .Create(clientId)
      ...
      if (response.IsSuccessStatusCode)
      {
        ...
        // WhoAmIResponse whoAmIresponse = Json.Serializer.Deserialize<WhoAmIResponse>(jsonContent);
